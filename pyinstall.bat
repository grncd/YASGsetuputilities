...
powershell -Command "Start-Process -FilePath '%PYTHON_INSTALLER%' -ArgumentList '/quiet','InstallAllUsers=1','PrependPath=1','Include_test=0','Include_pip=1','TargetDir=%LocalAppData%\Programs\Python\Python312','/log:%TEMP%\python_install.log' -Verb RunAs -Wait"
